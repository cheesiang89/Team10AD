...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:TextBox ID="txtBoxDeptCode" runat="server"></asp:TextBox>
    <br />
    ...
    <asp:TextBox ID="txtBoxContName" runat="server"></asp:TextBox>
    <br />
    <asp:Label ID="lblTelNum" runat="server" Text="Telephone No.:"></asp:Label>
    <asp:TextBox ID="txtBoxTelNum" runat="server"></asp:TextBox>
    <br />
    <asp:Label ID="lblRepName" runat="server" Text="Representative Name:"></asp:Label>
    <asp:TextBox ID="txtBoxRepName" runat="server"></asp:TextBox>

    <br />

    <asp:Label ID="lblColPoint" runat="server" Text="Collection Point:"></asp:Label>
    <asp:TextBox ID="txtBoxColPoint" runat="server"></asp:TextBox>
